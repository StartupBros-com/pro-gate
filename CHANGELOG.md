...
|---|---|---|---|
| v0.44.0 | 2026-09-06 | Pending release | Mixed cross-task verdicts rejected before publication or replay; owned answers and quoted examples preserved; Oracle session names remain unique per invocation |
