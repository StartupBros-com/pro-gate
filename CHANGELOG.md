...
|---|---|---|---|
| v0.44.0 | 2026-09-06 | Pending release | One run's block per published result: the collector cuts a two-marker answer to this run's verdict, refuses what it cannot attribute, and the Oracle session name is pinned to the run marker |
