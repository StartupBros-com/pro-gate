...
|---|---|---|---|
| v0.41.0 | 2026-09-07 | Pending release | Wait sizing: 60m fresh / 45m collection defaults from the ledger's p90, with the queued-review wait sized to match; reservation guard self-heal (orphan grace, start-time owner tokens, bounded retry); daemon envelope validation moved to the library and conformance-tested |
