...
|---|---|---|---|
| v0.55.2 | 2026-09-25 | Pending release | A pre-v0.55 PR round that left no review behind (charged, but no captured bytes, result, or conversation) no longer strands its unchanged head at `invalid-binding`; a legacy round that did leave a review still cannot trigger a replacement spend (#226) |
